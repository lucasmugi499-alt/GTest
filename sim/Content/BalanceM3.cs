...
public sealed record SocietyBalance(
    ...
    Fixed ServicesTransit, string ConnectivityKind, string WaterKind, string HealthKind, string CivilLibertiesFaction, string EmergencyPrecedent, string NationalizationPrecedent, Fine TrustRecoveryPerDay,
    ...
    Fixed LegitimacyAnsweringAttack, Fixed ProtestBelowWarSupport, Fixed MobilizationBlockedBelowWarSupport)
{
    public static SocietyBalance Read(ContentNode n)
    {
        ...
        return new SocietyBalance(
            ...
            n.Fixed("services_transit"), n.Str("connectivity_kind"), n.Str("water_kind"), n.Str("health_kind"), n.Str("civil_liberties_faction"), n.Str("emergency_precedent"), n.Str("nationalization_precedent"), n.Fine("trust_recovery_per_day"),
